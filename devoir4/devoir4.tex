...
\end{gather*}
Puisque l'orientation de la surface est négative et que le théorème de flux-
    divergence est vrai pour les surfaces orientées positivement, il suffit
    de multiplier $\text{div}\vec{F}\cdot -1$. Ainsi, pour les fins de
